		...
		<div class="row">
			...
			<div class="col-sm-8 gameInfoTop">
				...
				<div class="offersTop clearfix">
					...
					<?php /*<p class="lastLowest">Last Seen Lowest Price: <span itemprop="price">$<?php echo $prices[0]; ?></span></p> */ ?>
				</div>

				<?php if($fields['prices']) {
					// crafted_var_dump($fields); ?>
					<div v-if="showDbPrice == true" class="priceTable">
					<?php foreach($fields['prices'] as $row):
						ks_priceRepeater($row);					
					endforeach; ?>
					</div>
				<?php
				} ?>
